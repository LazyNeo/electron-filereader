<template>
  <ul>
    <el-row>
      <el-col :span="2">
        <el-button type="primary" icon="el-icon-arrow-left" circle @click="goto({name: 'csdHome'})"></el-button>
      </el-col>
      <el-col :span="16">
        {{directory}}
      </el-col>
  ...
  methods: {
    ...
    readData (files) {
      try {
        ...
        this.list = dataList.sort((a, b) => a.order - b.order)
